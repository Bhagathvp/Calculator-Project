...
public class Calculator implements ActionListener {
	...
	boolean isOperatorClicked=false, isDotClicked=false;
	...
	public Calculator() {
		...
		multiButton.setFont(new Font("arial",Font.BOLD, 40));
		jf.add(multiButton);
		...
		backSpace.setBounds(430, 130, 80, 80);
		backSpace.addActionListener(this);
		backSpace.setFont(new Font("arial",Font.BOLD, 40));
		jf.add(backSpace);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==sevenButton) {
			...
			if(check==1) { //plus
				 ...
				 displayLabel.setText(result+""); //to make result into string
				}
			
			else if(check==2) { //minus
				
				 result=oldValueF-newValueF;
				 displayLabel.setText(result+"");
				}
			else if(check==3) { //multiplication
				
				 result=oldValueF*newValueF;
				 displayLabel.setText(result+"");
				}
			else if(check==4) { //division
